    ...
    <router-link to="/">
      ...
      >
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
          <div class="font-bold text-4xl text-gray-100 pb-2"><h1>Video Compressor</h1></div>
          <div class="text-gray-300"><h2>Online video size reducer without loosing quality and without watermark.</h2></div>
        </div>
      </div>
    </router-link>
    ...
    >
      ...
      <div class="text-center pt-24 pb-2">
        <div class="text-center pb-2 text-gray-600 text-sm">
          &copy; 2024 TeamTheImageResizer.com. All rights reserved.
        </div>
      </div>
    </div>
  </div>
