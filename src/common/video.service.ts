...
export default class VideoService {
  ...
  private async transcode(
    ...
    store.commit("consoleMsg", "Compressing Started... Hold On....");
    ...
    store.commit("consoleMsg", "Compressing Completed... Wait for 5 sec if you didn't see any video file below.");
